...
('Chó Labrador Retriever', 15000000, 'Chó Labrador Retriever thuần chủng, 3 tháng tuổi, đã tiêm phòng đầy đủ, rất thân thiện và thông minh.', 'labrador.jpg', 'active', 9, NULL, 1),
('Chó Poodle Toy', 12000000, 'Chó Poodle Toy, 2 tháng tuổi, màu nâu đỏ, đã tiêm 2 mũi vaccine, rất xinh xắn và lanh lợi.', 'poodle_toy.jpg', 'sold', 9, 4, 1),
('Chó Corgi', 20000000, 'Chó Corgi đực, 4 tháng tuổi, màu vàng trắng, chân ngắn đáng yêu, rất vui vẻ và năng động.', 'corgi.jpg', 'sold', 11, 10, 1),
('Chó Husky Siberian', 18000000, 'Chó Husky Siberian cái, 5 tháng tuổi, lông dày, mắt xanh, đã huấn luyện cơ bản.', 'husky.jpg', 'sold', 11, 5, 1),
('Chó Golden Retriever', 16000000, 'Chó Golden Retriever, 3 tháng tuổi, màu vàng gold, tính cách hiền lành, thích hợp cho gia đình có trẻ em.', 'golden.jpg', 'sold', 13, 5, 1),

-- Sản phẩm thuộc danh mục Mèo
('Mèo Anh lông ngắn', 8000000, 'Mèo Anh lông ngắn (British Shorthair), 4 tháng tuổi, màu xám xanh, béo tròn đáng yêu.', 'british_shorthair.jpg', 'sold', 10, 5, 2),
('Mèo Ba Tư', 10000000, 'Mèo Ba Tư lông dài, 3 tháng tuổi, màu trắng, mặt tịt đặc trưng, rất sang chảnh.', 'persian_cat.jpg', 'sold', 10, 6, 2),
('Mèo Ragdoll', 15000000, 'Mèo Ragdoll thuần chủng, 6 tháng tuổi, màu point, mắt xanh, rất hiền và thân thiện.', 'ragdoll.jpg', 'active', 12, NULL, 2),
('Mèo Maine Coon', 20000000, 'Mèo Maine Coon, 5 tháng tuổi, màu tabby, kích thước lớn, đuôi dài đặc trưng.', 'maine_coon.jpg', 'sold', 12, 7, 2),
('Mèo Exotic', 9000000, 'Mèo Exotic lông ngắn, 4 tháng tuổi, màu cream, mặt tròn phúng phính, rất ngoan.', 'exotic_cat.jpg', 'active', 12, NULL, 2),

-- Sản phẩm thuộc danh mục Cá
('Cá Betta Halfmoon', 200000, 'Cá Betta Halfmoon đực, màu xanh đỏ rực rỡ, đuôi dài đẹp, khoảng 4 tháng tuổi.', 'betta_halfmoon.jpg', 'active', 13, NULL, 3),
('Cá Vàng Oranda', 500000, 'Cá Vàng Oranda cap đỏ, kích thước 10-12cm, rất khỏe mạnh và bắt mắt.', 'oranda_goldfish.jpg', 'sold', 13, 8, 3),
('Cá Koi Nhật', 2000000, 'Cá Koi Nhật Bản nhập khẩu, kích thước 20-25cm, hoa văn đẹp, phù hợp nuôi hồ lớn.', 'koi_fish.jpg', 'inactive', 9, NULL, 3),
('Cá Đĩa Wild', 1500000, 'Cá Đĩa (Discus) hoang dã, màu đỏ tự nhiên, kích thước 12-15cm, đã thuần hóa.', 'discus_fish.jpg', 'active', 10, NULL, 3),
('Cá Rồng', 5000000, 'Cá Rồng Bạch Kim (Platinum Arowana), dài 30cm, đã có giấy CITES, rất quý hiếm.', 'arowana.jpg', 'active', 13, NULL, 3),

-- Sản phẩm thuộc danh mục Chim
('Chim Vẹt Sun Conure', 15000000, 'Chim Vẹt Sun Conure 1 tuổi, màu sắc rực rỡ, đã thuần, biết nói vài từ đơn giản.', 'sun_conure.jpg', 'active', 10, NULL, 4),
('Chim Sáo Đen', 2000000, 'Chim Sáo Đen 8 tháng tuổi, đã biết hót và nói chuyện, rất thông minh.', 'mynah_bird.jpg', 'sold', 9, 10, 4),
('Chim Yến Phụng', 1000000, 'Chim Yến Phụng, màu vàng đỏ, hót hay, khoảng 6 tháng tuổi.', 'canary.jpg', 'active', 12, NULL, 4),
('Chim Họa Mi', 1500000, 'Chim Họa Mi trống, hót cực hay, đã được huấn luyện kỹ, khoảng 1 năm tuổi.', 'nightingale.jpg', 'sold', 13, 10, 4),
('Chim Vành Khuyên', 800000, 'Chim Vành Khuyên mái, giọng hót trong trẻo, khoảng 9 tháng tuổi.', 'finch_bird.jpg', 'active', 13, 10, 4),

-- Sản phẩm thuộc danh mục Sóc
('Sóc Bay Úc', 2500000, 'Sóc Bay Úc (Sugar Glider), 6 tháng tuổi, rất dễ thương và đã thuần hóa.', 'sugar_glider.jpg', 'sold', 9, 10, 5),
('Sóc Nhật', 1200000, 'Sóc Nhật Bản, màu xám trắng, rất tăng động và dễ nuôi.', 'japanese_squirrel.jpg', 'sold', 9, 6, 5),
('Sóc Đất', 900000, 'Sóc Đất, màu nâu vàng, hiền lành, đã được huấn luyện cơ bản.', 'ground_squirrel.jpg', 'active', 10, NULL, 5),
('Sóc Siberia', 1800000, 'Sóc Siberia lông dày, màu xám bạc, rất quý hiếm, khoảng 8 tháng tuổi.', 'siberian_squirrel.jpg', 'inactive', 10, NULL, 5),
('Sóc Flying Squirrel', 2200000, 'Sóc Bay (Flying Squirrel), có màng bay, màu đen tuyền, rất hiếm.', 'flying_squirrel.jpg', 'active', 11, NULL, 5),

-- Sản phẩm thuộc danh mục Thức ăn thú cưng
('Thức ăn hạt cho chó Royal Canin', 850000, 'Thức ăn hạt cao cấp cho chó Royal Canin, bao 10kg, dành cho chó trưởng thành mọi giống.', 'royal_canin.jpg', 'active', 11, NULL, 6),
('Pate cho mèo Whiskas', 25000, 'Pate Whiskas cho mèo vị cá ngừ, gói 85g, giàu dinh dưỡng.', 'whiskas.jpg', 'active', 12, NULL, 6),
('Thức ăn chim cảnh', 75000, 'Thức ăn hỗn hợp dành cho chim cảnh, túi 500g, giàu vitamin.', 'bird_food.jpg', 'active', 9, NULL, 6),
('Cám cá Tropical', 120000, 'Cám cá Tropical nhập khẩu, hộp 250g, phù hợp cho cá cảnh nhiệt đới.', 'fish_food.jpg', 'active', 10, NULL, 6),
('Thức ăn cho sóc', 150000, 'Thức ăn hỗn hợp dành cho sóc, bao gồm các loại hạt và trái cây khô, túi 500g.', 'squirrel_food.jpg', 'active', 10, NULL, 6),

-- Sản phẩm thuộc danh mục Phụ kiện
('Vòng cổ chó có khắc tên', 200000, 'Vòng cổ chó bằng da thật, có thể khắc tên theo yêu cầu, nhiều kích cỡ.', 'dog_collar.jpg', 'active', 11, NULL, 7),
('Cát vệ sinh cho mèo', 150000, 'Cát vệ sinh cho mèo, túi 8kg, hút mùi tốt, ít bụi.', 'cat_litter.jpg', 'sold', 12, 7, 7),
('Lồng chim inox', 500000, 'Lồng chim inox cao cấp, kích thước 40x60cm, thiết kế hiện đại.', 'bird_cage.jpg', 'active', 9, NULL, 7),
('Bể cá mini', 350000, 'Bể cá mini thông minh, tích hợp đèn LED và bơm lọc, dung tích 5 lít.', 'mini_aquarium.jpg', 'active', 13, NULL, 7),
('Lồng sóc', 450000, 'Lồng sóc lớn, kích thước 60x40x80cm, đầy đủ phụ kiện.', 'squirrel_cage.jpg', 'active', 10, NULL, 7),

-- Sản phẩm thuộc danh mục Dịch vụ
('Dịch vụ spa cho chó', 500000, 'Dịch vụ spa cao cấp cho chó, bao gồm tắm, sấy, cắt tỉa lông và móng.', 'dog_spa.jpg', 'active', 11, NULL, 8),
('Dịch vụ khám bệnh tại nhà', 800000, 'Dịch vụ khám bệnh tại nhà cho thú cưng, do bác sĩ thú y có chứng chỉ hành nghề thực hiện.', 'vet_service.jpg', 'active', 13, NULL, 8),
('Huấn luyện chó cơ bản', 5000000, 'Khóa huấn luyện chó cơ bản 10 buổi, dạy các lệnh căn bản và sửa hành vi xấu.', 'dog_training.jpg', 'sold', 11, 8, 8),
('Trông giữ mèo', 300000, 'Dịch vụ trông giữ mèo theo ngày, môi trường sạch sẽ, an toàn, có camera theo dõi.', 'cat_boarding.jpg', 'active', 12, NULL, 8),
('Dịch vụ cắt tỉa lông thú cưng', 250000, 'Dịch vụ cắt tỉa lông chuyên nghiệp cho chó, mèo theo yêu cầu.', 'grooming.jpg', 'active', 13, NULL, 8),

-- Sản phẩm thuộc danh mục Y tế & Thuốc
('Thuốc xổ giun cho chó', 80000, 'Thuốc xổ giun cho chó, tuýp 10 viên, phù hợp cho chó từ 5kg trở lên.', 'dewormer.jpg', 'active', 13, NULL, 9),
('Thuốc nhỏ gáy chống ve rận', 200000, 'Thuốc nhỏ gáy Frontline chống ve rận cho chó mèo, hộp 3 ống.', 'frontline.jpg', 'active', 13, NULL, 9),
('Vitamin tổng hợp cho mèo', 350000, 'Vitamin tổng hợp cho mèo dạng paste, tuýp 100g, bổ sung dinh dưỡng.', 'cat_vitamin.jpg', 'active', 12, NULL, 9),
('Thuốc điều trị nấm da', 120000, 'Thuốc điều trị nấm da cho chó mèo, chai xịt 100ml.', 'antifungal.jpg', 'active', 13, NULL, 9),
('Bộ sơ cứu thú cưng', 500000, 'Bộ dụng cụ sơ cứu cho thú cưng, bao gồm băng gạc, kẹp, kéo và các loại thuốc cơ bản.', 'pet_first_aid.jpg', 'sold', 13, 6, 9),

-- Sản phẩm thuộc danh mục Chuồng, nhà & giường
('Chuồng chó inox', 2500000, 'Chuồng chó inox cao cấp, kích thước 100x80x90cm, bền đẹp.', 'dog_kennel.jpg', 'active', 11, NULL, 10),
('Nhà gỗ cho mèo', 1500000, 'Nhà gỗ thiết kế 2 tầng cho mèo, kích thước 60x40x80cm, có cầu thang và góc nghỉ.', 'cat_house.jpg', 'active', 12, NULL, 10),
('Giường nệm cho chó', 800000, 'Giường nệm êm ái cho chó, chất liệu cotton, kích thước 80x60cm, có thể giặt được.', 'dog_bed.jpg', 'active', 11, NULL, 10),
('Hammock cho mèo', 400000, 'Hammock treo tường cho mèo, chất liệu canvas chắc chắn, thiết kế hiện đại.', 'cat_hammock.jpg', 'active', 12, NULL, 10),
('Lều vải cho thú cưng', 350000, 'Lều vải di động cho thú cưng, dễ dàng gấp gọn, kích thước 50x50x60cm.', 'pet_tent.jpg', 'active', 9, NULL, 10);
